...
describe('UtilsDuration', function () {
    ...
    describe('#Duration', function () {
        ...
        it('Duration getters more than 1 day', function () {
            let duration = new UtilsDuration.Duration(143874);
            let expectedDays = 1;
        ...
        it('Duration getters more than 2 days', function () {
            let duration = new UtilsDuration.Duration(237470);
            let expectedDays = 2;
        ...
        it('Duration getters less than 1 day', function () {
            let duration = new UtilsDuration.Duration(67841);
            let expectedDays = 0;
        ...
        it('Duration getters less than 1 minute', function () {
            let duration = new UtilsDuration.Duration(41);
            let expectedDays = 0;
            let expectedHours = 0;
        ...
        it('Duration constructor non-number: getters return NaN', function () {
            let duration = new UtilsDuration.Duration("2374a70");
